...
function ProfileContent() {
  ...
  const [editForm, setEditForm] = useState({ username: '', fullName: '', bio: '', location: '' });
                ...
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="bg-[var(--c-card)] border border-[var(--c-border)] rounded-[16px] p-4 flex flex-col items-start gap-2 hover:border-emerald-500/30 transition-colors">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-bold text-emerald-400">{isAuthenticated ? 'Email potvrđen' : 'Nepotvrđeno'}</p>
                        </div>
                    </div>
                </div>
